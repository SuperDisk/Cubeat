...
;; bit 5 = is a bomb
;; bit 4 = don't consider this tile when floodfilling
;; bit 0 = color
...
.done_fall_loop:
  ...
  ;; Spread bombs around
  ld hl, board.end-1
  lb de, %00110000, %00100000
REPT 198
  ld a, [hl-]
  and d
  cp e
  call z, floodfill_bomb
ENDR
...
;; floodfill bombs yeah
floodfill_bomb:
  ld bc, floodfill_stack

  ;; setup first element to process
  inc l
  ld a, l
  ld [bc], a
  inc c
...
floodfill_white:
  ...
  ld a, [hl-]
  and 1
  jr nz, .floodfill_white ; it's black, don't fill
